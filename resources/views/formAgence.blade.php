...
<form method="post" action="{{route('traitementagence')}}" class="text-uppercase">
    @csrf
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="formFile" name="nom" placeholder="Nom de l'agence" value="{{old("nom")}}">
