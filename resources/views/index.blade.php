...
<body>
	...
	<nav class="site-nav">
		<div class="container">
			<div class="site-navigation">
				<a href="index.html" class="logo m-0">Paradise Of Travel<span class="text-primary">.</span></a>
				...
				<ul class="js-clone-nav d-none d-lg-inline-block text-left site-menu float-right">
					...
					<li><a href="{{route('choixAdmin')}}">Agence</a></li>
					<li><a href="{{route('busclient')}}">Client</a></li>
				</ul>
	...
	<div class="untree_co-section">
		<div class="container">
			...
			<div class="owl-carousel owl-3-slider">
				...
				<div class="item">
					<a class="media-thumb" href="{{asset('vendors/images/hero-slider-1.jpg')}}" data-fancybox="gallery">
						<div class="media-text">
							<h3>Pragser Wildsee</h3>
							<span class="location">Italy</span>
						</div>
						<img src="{{asset('vendors/images/hero-slider-1.jpg')}}" alt="Image" class="img-fluid">
					</a> 
				</div>

				<div class="item">
					<a class="media-thumb" href="{{asset('vendors/images/hero-slider-2.jpg')}}')}}" data-fancybox="gallery">
						<div class="media-text">
							<h3>Oia</h3>
				...
				<div class="item">
					<a class="media-thumb" href="{{asset('vendors/images/hero-slider-3.jpg')}}" data-fancybox="gallery">
						<div class="media-text">
				...
				<div class="item">
					<a class="media-thumb" href="{{asset('vendors/images/hero-slider-4.jpg')}}" data-fancybox="gallery">
						<div class="media-text">
							<h3>Rialto Bridge</h3>
							<span class="location">Italy</span>
						</div>
				...
				<div class="item">
					<a class="media-thumb" href="{{asset('vendors/images/hero-slider-5.jpg')}}" data-fancybox="gallery">
						<div class="media-text">
					...
					<div class="owl-single owl-carousel no-nav">
						<div class="testimonial mx-auto">
							<figure class="img-wrap">
								<img src="{{asset('vendors/images/person_2.jpg')}}" alt="Image" class="img-fluid">
							</figure>
						...
						<div class="testimonial mx-auto">
							<figure class="img-wrap">
								<img src="{{asset('vendors/images/person_3.jpg')}}" alt="Image" class="img-fluid">
							</figure>
						...
						<div class="testimonial mx-auto">
							<figure class="img-wrap">
								<img src="{{asset('vendors/images/person_4.jpg')}}" alt="Image" class="img-fluid">
							</figure>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-6 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
					<div class="media-1">
						<a href="#" class="d-block mb-3"><img src="{{asset('vendors/images/hero-slider-1.jpg')}}" alt="Image" class="img-fluid"></a>
				...
				<div class="col-6 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
					<div class="media-1">
						<a href="#" class="d-block mb-3"><img src="{{asset('vendors/images/hero-slider-2.jpg')}}" alt="Image" class="img-fluid"></a>
						<span class="d-flex align-items-center loc mb-2">
							<span class="icon-room mr-3"></span>
				...
				<div class="col-6 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
					<div class="media-1">
						<a href="#" class="d-block mb-3"><img src="{{asset('vendors/images/hero-slider-3.jpg')}}" alt="Image" class="img-fluid"></a>
						<span class="d-flex align-items-center loc mb-2">
							<span class="icon-room mr-3"></span>
							<span>Malaysia</span>
						</span>
				...
				<div class="col-6 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
					<div class="media-1">
						<a href="#" class="d-block mb-3"><img src="{{asset('vendors/images/hero-slider-4.jpg')}}" alt="Image" class="img-fluid"></a>
			...
			<div class="row justify-content-between align-items-center">
				...
				<div class="col-lg-6">
					<figure class="img-play-video">
						...
						<img src="{{asset('vendors/images/hero-slider-2.jpg')}}" alt="Image" class="img-fluid rounded-20">
					</figure>
				</div>
	...
	<script src="{{asset('vendors/js/jquery.animateNumber.min.js')}}"></script>
	...
	<script src="{{asset('vendors/js/typed.js')}}"></script>
	<script>
		$(function() {
			var slides = $('.slides'),
			...
			var typed = new Typed('.typed-words', {
				strings: ["DOUALA."," YAOUNDE."," KRIBI.", "LIMBE.", "BAFOUSSAM."],
				typeSpeed: 80,
				backSpeed: 80,
				backDelay: 4000,
				startDelay: 1000,
